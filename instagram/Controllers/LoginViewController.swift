...
class LoginViewController: UIViewController {
    ...
    func setupUI(){
        ...
        stackview.anchor(top: view.topAnchor, left: view.leftAnchor, right: view.rightAnchor, bottom: nil, paddingTop: view.frame.height / 3, paddingLeft: 20, paddingRight: 20, paddingBottom: 0, width: 0, height: 140)
        
        logoContainerView.anchor(top: nil, left: view.leftAnchor, right: view.rightAnchor, bottom: stackview.topAnchor, paddingTop: 0,  paddingLeft: 20, paddingRight: 20,  paddingBottom: 30, width: 0, height: 50)
        
        dontHaveAccountButton.anchor(top: nil, left: view.leftAnchor, right: view.rightAnchor, bottom: view.bottomAnchor, paddingTop: 0, paddingLeft: 20, paddingRight: 20, paddingBottom: 40, width: 0, height: 40)
